...
[_BASE] = LAYOUT_split_3x5_3(
   ...
   M2(KC_Z),   M3(KC_X),     M4(KC_C),        KC_V, KC_B,                                               KC_N,        KC_M,     KC_COMM,      KC_DOT,     KC_SLSH,
                                           KC_LBRC, KC_RBRC, LT(_NUM, KC_SPC),     LT(_NAV, KC_ENT), KC_QUOT,     KC_BSPC
),

[_NUM] = LAYOUT_split_3x5_3(
       KC_1,        KC_2,        KC_3,        KC_4,    KC_5,                                            KC_6,        KC_7,        KC_8,        KC_9,        KC_0,
M1(KC_EXLM),   M2(KC_AT), M3(KC_HASH),  M4(KC_DLR), KC_PERC,                                         KC_CIRC, M4(KC_AMPR), M3(KC_ASTR), M2(KC_LPRN), M1(KC_RPRN),
    XXXXXXX,     XXXXXXX,     XXXXXXX,     XXXXXXX, XXXXXXX,                                          KC_GRV,     KC_BSLS,     KC_MINS,     XXXXXXX,     XXXXXXX,
                                           XXXXXXX, XXXXXXX, XXXXXXX,                       MO(_FN),  KC_EQL,      KC_DEL
),
...
[_FN] = LAYOUT_split_3x5_3(
    ...
    XXXXXXX,     XXXXXXX,     XXXXXXX,     XXXXXXX, XXXXXXX,                                         XXXXXXX,     XXXXXXX,     XXXXXXX,     XXXXXXX,     XXXXXXX,
                                           XXXXXXX, XXXXXXX, XXXXXXX,                       _______,  KC_EQL,      KC_DEL
),
};
