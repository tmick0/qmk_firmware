...
M1(KC_EXLM),   M2(KC_AT), M3(KC_HASH),  M4(KC_DLR), KC_PERC, XXXXXXX,    XXXXXXX,  KC_CIRC, M4(KC_AMPR), M3(KC_ASTR), M2(KC_LPRN), M1(KC_RPRN),
    ...
    XXXXXXX,      KC_F11,      KC_F12,     XXXXXXX,       XXXXXXX,            XXXXXXX,           KC_GRV,      KC_EQL,      KC_DEL,     XXXXXXX
),
...
[_NAV] = LAYOUT_planck_2x2u(
    ...
    XXXXXXX,     XXXXXXX,     XXXXXXX,     XXXXXXX,       KC_TAB,             XXXXXXX,         RGB_TOG,     RGB_MOD,      KC_DEL,     XXXXXXX
),
