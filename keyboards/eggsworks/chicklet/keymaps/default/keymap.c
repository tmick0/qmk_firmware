...
[_BASE] = LAYOUT(
   ...
   XXXXXXX,    XXXXXXX,       KC_LBRC,     LT(_NUM, KC_SPC),       LT(_NAV, KC_ENT),     KC_BSPC,     XXXXXXX,     XXXXXXX
),
...
M1(KC_EXLM),   M2(KC_AT), M3(KC_HASH),  M4(KC_DLR), KC_PERC,   KC_CIRC, M4(KC_AMPR), M3(KC_ASTR), M2(KC_LPRN), M1(KC_RPRN),
    ...
    XXXXXXX,     XXXXXXX,      KC_RBRC,     XXXXXXX,                   MO(_FN),            KC_DEL,    XXXXXXX,     XXXXXXX
),
...
[_NAV] = LAYOUT(
    ...
    XXXXXXX,     XXXXXXX,     XXXXXXX,          KC_TAB,               _______,            KC_DEL,     XXXXXXX,     XXXXXXX
),
