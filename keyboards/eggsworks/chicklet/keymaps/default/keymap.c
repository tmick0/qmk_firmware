...
[_BASE] = LAYOUT(
   ...
   M1(KC_Z),       KC_X,         KC_C,        KC_V,             KC_B,                 KC_N,        KC_M,     KC_COMM,      KC_DOT,     KC_SLSH,
             M2(KC_LBRC), M3(KC_RBRC), M4(KC_BSLS), LT(_NUM, KC_SPC),     LT(_NAV, KC_ENT),     KC_MINS,     KC_QUOT,     KC_BSPC
),
...
M1(KC_EXLM),   M2(KC_AT), M3(KC_HASH),  M4(KC_DLR),          KC_PERC,              KC_CIRC, M4(KC_AMPR), M3(KC_ASTR), M2(KC_LPRN), M1(KC_RPRN),
      KC_F1,       KC_F2,       KC_F3,       KC_F4,            KC_F5,                KC_F6,       KC_F7,       KC_F8,       KC_F9,      KC_F10,
                  KC_F11,      KC_F12,     XXXXXXX,          XXXXXXX,              XXXXXXX,      KC_GRV,      KC_EQL,      KC_DEL
),
...
[_NAV] = LAYOUT(
    ...
    XXXXXXX,     KC_HOME,      KC_ESC,      KC_END,          KC_MUTE,              XXXXXXX,     XXXXXXX,     XXXXXXX,     XXXXXXX,     XXXXXXX,
                 XXXXXXX,     XXXXXXX,     XXXXXXX,           KC_TAB,              XXXXXXX,     XXXXXXX,     XXXXXXX,      KC_DEL
),
